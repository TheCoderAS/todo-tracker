...
export default function AuthIntro() {
  return (
    <Card className="bg-slate-900/50">
      <span className="inline-flex items-center gap-2 rounded-full border border-sky-500/30 bg-sky-500/10 px-4 py-1 text-xs font-medium uppercase text-sky-200">
        Modern workspace
      </span>
